...
from src.model import project_models
...
dialect: str = db_conf.db_dialect
driver: str = db_conf.db_driver
username: str = db_conf.db_username
password: str = db_conf.db_password
host: str = db_conf.db_host
